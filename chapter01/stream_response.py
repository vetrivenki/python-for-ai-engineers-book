...
Run live:          python stream_response.py
Offline success:   python stream_response.py --fake
Offline failure:   python stream_response.py --fake --interrupt
Buffered output:   python stream_response.py --fake --buffered
"""
